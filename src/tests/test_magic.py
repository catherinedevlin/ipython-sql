...
def _setup_writer():
    ip.run_line_magic('sql',
                      'sqlite:// CREATE TABLE writer (first_name, last_name, year_of_death)')
    ip.run_line_magic('sql',
                      "sqlite:// INSERT INTO writer VALUES ('William', 'Shakespeare', 1616)")
    ip.run_line_magic('sql',
                      "sqlite:// INSERT INTO writer VALUES ('Bertold', 'Brecht', 1956)")
...
def test_access_results_by_keys():
    assert ip.run_line_magic('sql',
                             "sqlite:// SELECT * FROM writer;")['William'] == (u'William', u'Shakespeare', 1616)
...
def test_displaylimit():
    ...
    result = ip.run_line_magic('sql',
                               "sqlite:// SELECT * FROM (VALUES ('apple'), ('banana'), ('cherry')) AS Result ORDER BY 1;")
